     ...
     <div id="forms" class="mt10">
        <div class="box">
          <div class="box_border">
          	<form action="good/insert" enctype="multipart/form-data" class="jqtransform" method="post" id="user_form">
               ...
               <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <!-- 旧价格 -->
                 <tr>
                  ...
                  <td class=""> 
                    <input type="text" id="oldprice" name="oldprice" value="" class="input-text lh30 input-text-right" size="40">
                  </td>
                </tr>
                <!-- 新价格 -->
                <tr>
                  ...
                  <td class=""> 
                    <input type="text" id="newprice" name="newprice" value="" class="input-text lh30 input-text-right" size="40">
                  </td>
                </tr>
                <!-- 备注 -->
                <tr>
                  ...
                  <td class=""> 
                    <input type="text" id="remark" name="remark" value="" class="input-text lh30 input-text-right" size="40">
                  </td>
                </tr>
                <!-- 分类id -->
                <tr>
                ...
                <tr>
                  ...
                  <td class=""> 
                    <input type="text" id="num" name="num" value="" class="input-text lh30 input-text-right" size="40">
                  </td>
                </tr>
                <!-- 商品图片 -->
               <tr>
                <td class="td_right">商品图片： </td>
				<td>&nbsp;&nbsp;&nbsp;<input type="file" name="up3"></td>
                 </tr>
                 <!-- 是否热销 -->
                 <tr>
                  <td class="td_right">是否热销：</td>
                  <td class=""> 
                    <input type="text" id="hot" name="hot" value="" class="input-text lh30 input-text-right" size="40">
                  </td>
                </tr>
                <!-- 增加时间 -->
                  <tr>
                ...
                <tr>
                  ...
                  <td class=""> 
                    <input type="text" id="sort" name="sort" value="" class="input-text lh30 input-text-right" size="40">
                  </td>
                </tr>
                <!-- 规格 -->
                 <tr>
                  ...
                  <td class=""> 
                    <input type="text" id="standard" name="standard" value="" class="input-text lh30 input-text-right" size="40">
                  </td>
                </tr>
